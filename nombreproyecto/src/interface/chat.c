 ...
 * \b add_new_page(3), \b delete_page(3), \b get_name_page(3).
 *
 ...
 *
 * @section seealso VER TAMBIÉN
 * \b currentPage(3), \b delete_page(3), \b get_name_page(3).
 *
 * @section authors AUTOR
 * Eloy Anguiano (eloy.anguiano@uam.es)
*/
 ...
 * 	\b #include \b <redes2/chat.h>
 *
 *	\b int \b get_name_page \b (\b int\b *\b index\b )
 * 
 * @section descripcion DESCRIPCIÓN
 *
 ...
 *
 * @section seealso VER TAMBIÉN
 * \b current_page(3), \b delete_page(3), \b add_new_page(3).
 *
 * @section authors AUTOR
 * Eloy Anguiano (eloy.anguiano@uam.es)
*/
 ...
 *
 * @section seealso VER TAMBIÉN
 * \b current_page(3), \b get_name_page(3), \b add_new_page(3).
 *
 * @section authors AUTOR
 * Eloy Anguiano (eloy.anguiano@uam.es)
*/
